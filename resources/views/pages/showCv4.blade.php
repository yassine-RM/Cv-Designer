<div class="row  text-dark" id="divContent">
    ...
    <div class="col-12 " id="contentPrint">
        ...
        <div class="row  " :style="bgColor">
            <div class="col-6">
                <h5 class="card-title">
                    <h3 :style="bgColorText"><i class="fa fa-align-justify "></i>
                        Présentation </h3>
                </h5>
                            ...
                            <div class="col-7">
                                <div class="progress">
                                    <div class="progress-bar-striped"
                                        :style="'width:'+ competence.pourcentage+'% ;'+bgColor" role="progressbar"
                    ...
                    <div class="col-12">
                        ...
                        <div class="row" v-for='langue in Langues'>
                            ...
                            <div class="col-7">
                                <div class="progress">
                                    <div class="progress-bar-striped "
                                        :style="'width:'+langue.pourcentage+'% ;'+bgColor" role="progressbar"
                                        aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
