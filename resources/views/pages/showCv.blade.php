        ...
        <div class="row  ">
            <div class=" col-3 p-3" :style="bgColor">
                <div class="text-center">
                    <img :src="Cv.photo" alt="cv photo" width="150" height="150" class="rounded-circle">
                </div>
                <div class="mt-5 ">
                    <h5 class=" card-title ">
                        <h3 class="text-primary" style="text-decoration: underline"><i class="fa fa-info-circle "></i>
                            Info</h3>
                    ...
                    <h5 class="card-title">
                        <h3 class="text-primary" style="text-decoration: underline"><i class="fa fa-phone"></i> Contact
                        </h3>
                    </h5>
                    ...
                    <h5 class="card-title">
                        <h3 class="text-primary" style="text-decoration: underline"><i class="fa fa-align-justify"></i>
                            Présentation </h3>
                    </h5>
                ...
                <div class="row bg-light">
                    <div class="col col-10 p-3  ">
                        <h1 style="font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif">
                            @{{Infos.civilite}} &nbsp; @{{Infos.nom}}&nbsp;&nbsp;@{{Infos.prenom}}</h1>
                        <div class="text-info">
                            <h3>@{{Cv.titre}}</h3>
                        </div>
                ...
                <div class="row">
                    <div class="col col-8">
                        <div class="row bg-light mt-1 ">
                            <div class="col-12">
                                <div class="row">
                                    <p class="card-text">
                                        <h2 :style="bgColor" v-if='Formations.length' class="text-primary"><i
                                                class="text-primary fa fa-graduation-cap"></i>
                                            Formations</h2>
                                    </p>
                                </div>
                        ...
                        <div class="row bg-light mt-1">
                            <div class="col-12">
                                <div class="row mt-2">
                                    <p class="card-text">
                                        <h2 :style="bgColor" v-if='Experiences.length' class="text-primary"><i
                                                class="text-primary fa fa-suitcase"></i> Experiences
                                        </h2>
                                    </p>
                                </div>
                        ...
                        <div class="row bg-light mt-2">
                            <div class="col-12">
                                <div class="row ">
                                    <p class="card-text">
                                        <h2 :style="bgColor" v-if='Loisires.length' class="text-primary"><i
                                                class="text-primary fa fa-paper-plane-o"></i>
                                            Loisires</h2>
                                    </p>
                                </div>
                    ...
                    <div class="col col-4 ">
                        <div class="row bg-light mt-1 ">
                            <div class="col-12">
                                <p class="card-text ">
                                    <h2 :style="bgColor" v-if='Competences.length' class="text-primary">
                                        <i class="text-primary fa fa-id-card"></i> Competences</h2>
                                </p>
                        ...
                        <div class="row bg-light mt-1 ">
                            <div class="col-12">
                                <p class="card-text">
                                    <h2 :style="bgColor" v-if='Langues.length' class="text-primary"><i
                                            class="text-primary fa fa-language"></i> Langues</h2>
                                </p>
