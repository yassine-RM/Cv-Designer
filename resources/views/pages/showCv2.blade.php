            ...
            <div class="col-3  " :style="bgColor">
                ...
                <div class="mt-5 ">
                    <h5 id="print" class=" card-title ">
                        <h3 class="text-warning" style="text-decoration: underline"><i class="fa fa-info-circle "></i>
                            Info</h3>
                    ...
                    <h5 class="card-title">
                        <h3 class="text-warning" style="text-decoration: underline"><i class="fa fa-phone"></i> Contact
                        </h3>
                    </h5>
                    ...
                    <h5 class="card-title">
                        <h3 class="text-warning" style="text-decoration: underline"><i class="fa fa-align-justify"></i>
                            Présentation </h3>
                    </h5>
